...
%Another reason are the rising gas prices. Since the most expensive generator needed to meet the demand sets the price, with rising gas prices the marginal cost of the gas power plants increases, which influences the electricity price strongly. 
...
% Generation from pumped-storage hydro has a positive relationship with the market price.
...
%\begin{figure}
    %\centering
    %\includegraphics[width=0.8\columnwidth]{doc/fig/pumped_hydro_regression.pdf}
    %\caption{Caption}
